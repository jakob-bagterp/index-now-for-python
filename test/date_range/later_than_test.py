...
from index_now import LaterThan

JAN_1_2025 = datetime(2025, 1, 1)


@pytest.mark.parametrize(
    "date, date_to_check, expected",
    [
...
def test_date_range_later_than(date: datetime, date_to_check: datetime, expected: bool) -> None:
    date_range = LaterThan(date)
