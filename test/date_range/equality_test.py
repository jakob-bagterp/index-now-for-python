...
@pytest.mark.parametrize(
    "date_range1, date_range2, expected",
    [
        (
            DateRange(start=datetime(2025, 1, 1), end=datetime(2025, 1, 31)),
            DateRange(start=datetime(2025, 1, 1), end=datetime(2025, 1, 31)),
            True,
        ),
        (
            DateRange(start=datetime(2025, 1, 1), end=datetime(2025, 1, 31)),
            DateRange(start=datetime(2025, 1, 1), end=datetime(2025, 1, 30)),
            False,
        ),
        ...
        (
            Between(datetime(2025, 1, 1), datetime(2025, 1, 31)),
            Between(datetime(2025, 1, 1), datetime(2025, 1, 31)),
            True,
        ),
        (
            Between(datetime(2025, 1, 1), datetime(2025, 1, 31)),
            Between(datetime(2025, 1, 1), datetime(2025, 1, 30)),
            False,
        ),
        ...
        (
            DaysAgo((datetime.today() - datetime(2025, 1, 1)).days),
            DateRange(start=datetime(2025, 1, 1), end=datetime(2025, 1, 31)),
            False,
        ),
        ...
        (
            LaterThanAndIncluding(datetime(2025, 1, 1)),
            DateRange(start=datetime(2025, 1, 1), end=datetime(2025, 1, 31)),
            False,
        ),
        ...
        (
            EarlierThanAndIncluding(datetime(2025, 1, 1)),
            DateRange(start=datetime(2025, 1, 1), end=datetime(2025, 1, 31)),
            False,
        ),
    ],
