...
@pytest.mark.parametrize("sitemap_urls, filter, expected", [
    ...
    (SITEMAP_INCONSISTENT, SitemapFilter(change_frequency=ChangeFrequency.DAILY), SITEMAP_INCONSISTENT_LOC),
    (SITEMAP_INCONSISTENT, SitemapFilter(change_frequency="daily"), SITEMAP_INCONSISTENT_LOC),
    (SITEMAP_INCONSISTENT, SitemapFilter(date_range=DateRange(start=datetime(2025, 3, 15), end=datetime(2025, 3, 20))), SITEMAP_INCONSISTENT_LOC),
    (SITEMAP_INCONSISTENT, SitemapFilter(date_range=Between(datetime(2025, 1, 20), datetime(2025, 2, 20))), SITEMAP_INCONSISTENT_LOC),
    (SITEMAP_INCONSISTENT, SitemapFilter(date_range=Today()), SITEMAP_INCONSISTENT_LOC),
    (SITEMAP_INCONSISTENT, SitemapFilter(date_range=Yesterday()), SITEMAP_INCONSISTENT_LOC),
    (SITEMAP_INCONSISTENT, SitemapFilter(date_range=DaysAgo(2)), SITEMAP_INCONSISTENT_LOC),
